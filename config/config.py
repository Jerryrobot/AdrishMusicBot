...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Mradrish69/AdrishMusicBot",
)
...
)  # Example:- https://t.me/TheAdrish
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", None
)  # Example:- https://t.me/AdrishSupport
...
# You'll need a Pyrogram String Session for these vars. Generate String from our session generator bot @AdrishStringBot
