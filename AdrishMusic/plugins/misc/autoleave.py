...
from AdrishMusic.core.call import Adrish, autoend
from AdrishMusic.utils.database import (get_client, is_active_chat,
                                       is_autoend)
                    ...
                    async for i in client.iter_dialogs():
                        ...
                        if chat_type in [
                            ...
                            if (
                                ...
                                and chat_id != -1001584378790
                                and chat_id != -1001887398698
                                and chat_id != -1001756529460
                            ):
                                if left == 20:
                                    continue
